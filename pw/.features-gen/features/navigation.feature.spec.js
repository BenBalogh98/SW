...
test.describe('Planet Card Details', () => {
  ...
  test('Navigate to Planets page from planet details through the breadcrumb', async ({ Given, When, Then, cardPage, homePage, page, planetPage }) => { 
    await Given('I am on the "Planets" card page', null, { homePage, page }); 
    await When('I click on the "Tatooine" planet card', null, { planetPage }); 
    await Then('I should see detailed information of "Planets"', {"dataTable":{"rows":[{"cells":[{"value":"Population"}]},{"cells":[{"value":"Residents"}]},{"cells":[{"value":"Films"}]}]}}, { cardPage }); 
    await When('I click on the "Planets" link in the breadcrumb', null, { homePage }); 
    await Then('I should be back on the "Planets" page', null, { homePage }); 
  });

  test('Navigate to Home page from planet details through the breadcrumb', async ({ Given, When, Then, cardPage, homePage, page, planetPage }) => { 
    await Given('I am on the "Planets" card page', null, { homePage, page }); 
    await When('I click on the "Tatooine" planet card', null, { planetPage }); 
    await Then('I should see detailed information of "Planets"', {"dataTable":{"rows":[{"cells":[{"value":"Population"}]},{"cells":[{"value":"Residents"}]},{"cells":[{"value":"Films"}]}]}}, { cardPage }); 
    await When('I click on the "Home" link in the breadcrumb', null, { homePage }); 
    await Then('I should be back on the "Home" page', null, { homePage }); 
  });
...
const bddFileData = [ // bdd-data-start
  ...
  {"pwTestLine":22,"pickleLine":41,"tags":[],"steps":[{"pwStepLine":23,"gherkinStepLine":42,"keywordType":"Context","textWithKeyword":"Given I am on the \"Planets\" card page","stepMatchArguments":[{"group":{"start":12,"value":"\"Planets\"","children":[{"start":13,"value":"Planets","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"}]},{"pwStepLine":24,"gherkinStepLine":43,"keywordType":"Action","textWithKeyword":"When I click on the \"Tatooine\" planet card","stepMatchArguments":[{"group":{"start":15,"value":"\"Tatooine\"","children":[{"start":16,"value":"Tatooine","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"}]},{"pwStepLine":25,"gherkinStepLine":44,"keywordType":"Outcome","textWithKeyword":"Then I should see detailed information of \"Planets\"","stepMatchArguments":[{"group":{"start":37,"value":"\"Planets\"","children":[{"start":38,"value":"Planets","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"}]},{"pwStepLine":26,"gherkinStepLine":48,"keywordType":"Action","textWithKeyword":"When I click on the \"Planets\" link in the breadcrumb","stepMatchArguments":[{"group":{"start":15,"value":"\"Planets\"","children":[{"start":16,"value":"Planets","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"}]},{"pwStepLine":27,"gherkinStepLine":49,"keywordType":"Outcome","textWithKeyword":"Then I should be back on the \"Planets\" page","stepMatchArguments":[{"group":{"start":24,"value":"\"Planets\"","children":[{"start":25,"value":"Planets","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"}]}]},
  {"pwTestLine":30,"pickleLine":51,"tags":[],"steps":[{"pwStepLine":31,"gherkinStepLine":52,"keywordType":"Context","textWithKeyword":"Given I am on the \"Planets\" card page","stepMatchArguments":[{"group":{"start":12,"value":"\"Planets\"","children":[{"start":13,"value":"Planets","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"}]},{"pwStepLine":32,"gherkinStepLine":53,"keywordType":"Action","textWithKeyword":"When I click on the \"Tatooine\" planet card","stepMatchArguments":[{"group":{"start":15,"value":"\"Tatooine\"","children":[{"start":16,"value":"Tatooine","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"}]},{"pwStepLine":33,"gherkinStepLine":54,"keywordType":"Outcome","textWithKeyword":"Then I should see detailed information of \"Planets\"","stepMatchArguments":[{"group":{"start":37,"value":"\"Planets\"","children":[{"start":38,"value":"Planets","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"}]},{"pwStepLine":34,"gherkinStepLine":58,"keywordType":"Action","textWithKeyword":"When I click on the \"Home\" link in the breadcrumb","stepMatchArguments":[{"group":{"start":15,"value":"\"Home\"","children":[{"start":16,"value":"Home","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"}]},{"pwStepLine":35,"gherkinStepLine":59,"keywordType":"Outcome","textWithKeyword":"Then I should be back on the \"Home\" page","stepMatchArguments":[{"group":{"start":24,"value":"\"Home\"","children":[{"start":25,"value":"Home","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"}]}]},
]; // bdd-data-end